...
public sealed partial class EffectBackgroundDancerInverse() :
    ColorRect()
{
    ...
    {
        foreach (var instance in EffectBackgroundDancerInverse.Instances)
        {
    ...
    private static readonly List<EffectBackgroundDancerInverse> Instances                         = [];
    ...
    {
        EffectBackgroundDancerInverse.Instances.Add(
            item: this
        );
    }
