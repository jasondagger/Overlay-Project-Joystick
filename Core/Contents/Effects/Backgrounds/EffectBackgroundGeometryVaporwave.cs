...
public sealed partial class EffectBackgroundGeometryVaporwave() :
    ColorRect()
{
    ...
    {
        EffectBackgroundGeometryVaporwave.s_initialColorInverse = color;
    }
    ...
    {
        EffectBackgroundGeometryVaporwave.s_initialColorNormal = color;
    }
    ...
    {
        foreach (var instance in EffectBackgroundGeometryVaporwave.Instances)
        {
    ...
    private static readonly List<EffectBackgroundGeometryVaporwave> Instances                         = [];
    ...
    private float                                          m_timeUntilNextRandomization      = EffectBackgroundGeometryVaporwave.c_randomizeTime;
    private float                                          m_transitionProgress              = 1f;
    
    private void AddInstance()
        {
            EffectBackgroundGeometryVaporwave.Instances.Add(
                item: this
            );
        }
    ...
    private void SetShaderMaterial()
    {
        ...
        this.m_colorInverse = EffectBackgroundGeometryVaporwave.s_initialColorInverse;
        this.m_colorNormal  = EffectBackgroundGeometryVaporwave.s_initialColorNormal;
    ...
    )
    {
        ...
        if (this.m_timeUntilNextRandomization <= 0f)
        {
            ...
            this.m_timeUntilNextRandomization = EffectBackgroundGeometryVaporwave.c_randomizeTime;
        }
